...
#Below not necessarily needed for python compilation for this particular demo but for completeness
...
# For service catalog app - not needed now
# #Install Redis

...
# Note - this version of 'bigip_facts' includes backported changes from 
# ansible 2.0 developer branch in github. We need the 'validate_certs'
# input to this module so that openssl does not fail when
# iControlSOAP creates an HTTPS connection with a self-signed cert.
# Further, the following lines (1549,1550):
#    import ssl
#    ssl._create_default_https_context = ssl._create_unverified_context
# require that we use python 2.7.9 which includes backported updates to 
# python 'ssl' built-in library.
